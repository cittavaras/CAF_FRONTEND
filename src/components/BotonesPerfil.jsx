...
const BotonesPerfil = () => {
  ...
  const handleOpenInformeMetrica = () => {
    setInformeMetrica(true);
  };
        ...
        <Row className="botonesperfil gap-2 m-2 justify-content-center">
          {hasRole(roles.admin) && (
            <>
              ...
              <Col
                lg={"auto"}
                className="col-12 col-md-2 col-sm-3"
                style={{ backgroundColor: "#FCB32E" }}
              >
                <Link className="btn" to="/listar" style={{ color: "#042945" }}>
              ...
              >
                <button
                  className="btn"
                  style={{ color: "#042945" }}
                  onClick={handleOpenInformeMetrica}
                >
                  Informe de Metricas de alumno
                </button>
              </Col>
              <Col
                lg={"auto"}
          ...
          {hasRole(roles.instructor) && (
            <>
              ...
              <Col
                ...
                style={{ backgroundColor: "#FCB32E" }}
              >
                <Link className="btn" to="/listarActivos">
                  Buscar Alumnos
                </Link>
              </Col>
              <Col
          ...
          {open && (
            <ReservarSesion
              ...
              reservasAlumno={reservasAlumno}
              getReservasByAlumno={getReservasByAlumno}
            />
          )}
          {asistenciaOpen && (
            <InformeAsistencia
              open={asistenciaOpen}
              setOpen={setAsistenciaOpen}
              handleClose={handleCloseInforme}
            />
          )}
          {informeMetrica && (
            <InformeMetricas
