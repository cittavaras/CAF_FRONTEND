...
const RegistroRutinas = (props) => {
  ...
  const fechaDiaActual = moment().format('DD');
  const fechaMesActual = moment().format('MMMM');
  ...
  return (
    <>
      ...
      <Box sx={{ margin: '21px', display: 'flex', alignItems: 'center', justifyContent: 'flex-start', flexWrap: 'wrap' }}>
        <svg xmlns="http://www.w3.org/2000/svg" width="130px" height="85px" viewBox="0 0 144 94" fill="none">
        ...
        <p className="tituloRegistroRuti">
          REGISTRO DE
          <br />
          RUTINA
        </p>
      ...
      {/*Aqui  empezamos con la informacion de las cosas*/}
      <p className="tituloRegRut">Instructor</p>
      <p className="registroRutina">{alumno?.nombre ?? 'Sin informacion'}</p>
      <p className="tituloRegRut">Alumno</p>
      <p className="registroRutina">{alumnoSeleccionado && `${alumnoSeleccionado.nombre}`}</p>
      {/* aqui va el dia y la fecha y los demas inputs 
        Tenemos un grid area, con dos columnas y 3 filas
       */}
      <div className="grid-layout-regrutina">
        {/*Este es el primer box que indica la fecha*/}
        <div className="fechaRutina">
        ...
        <div className="boxRutinaRegistro" >
          <div>
            <FormControl
              className="dropdown-rutina-box">
              <InputLabel style={{ color: 'white' }}>Rutina</InputLabel>
              <Select
                sx={{ color: 'white' }}
                name="rutina"
                value={nomRutina}
      ...
      {/* Boton agregar ejercico  debe ir centrado y debe agregar la informa*/}
      <div className="">
        {/* <button className="btn btn-secondary" style={{ width: '100%' }} onClick={agregarEjercicio}>
            Agregar Ejercicio
          </button> */}
