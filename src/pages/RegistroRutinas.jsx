...
const RegistroRutinas = (props) => {
  ...
  return (
    <>
      ...
      <Box className="justify-content-around" sx={{ margin: '21px', display: 'flex', alignItems: 'center', flexWrap: 'wrap' }}>
      ...
      <section>
        <div className="text-center intructor-alumno">
          <p>Instructor</p>
      ...
      <div className="row form-registro-rutinas">
